    ...
    <div className="encyclopedia ui-layer">
      ...
      <div className="enc-content">
        {archiveCategory === 'NONE' ? (
          <div className="menu-content-centered" style={{ gap: '20px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', width: '100%', maxWidth: '400px' }}>
              <button className="blue-button" onClick={() => handleCategorySelect('TACTICAL', 'VIRAL DB')}>&gt; TACTICAL_DATABASE</button>
              <button className="blue-button" onClick={() => handleCategorySelect('HANDBOOK', 'LOGIC')}>&gt; SYSTEM_HANDBOOK</button>
              <button className="blue-button" onClick={() => handleCategorySelect('MANIFEST', 'LORE')}>&gt; MAINFRAME_MANIFEST</button>
            </div>
          </div>
        ) : (
          <>
            <div className="info-tabs">
              ...
              <button className="back-tab-btn" onClick={() => { am.playUiClick(); setArchiveCategory('NONE'); setIsTypingComplete(false); }}>BACK</button>
            </div>
