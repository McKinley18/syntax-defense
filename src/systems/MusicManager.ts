...
export class MusicManager {
    ...
    private constructor() {
        ...
        if (saved) {
            try {
                ...
                console.warn("FAILED_TO_LOAD_TRACK_PREFS");
            }
        }
    }
    ...
    public init(ctx: AudioContext, destination: AudioNode) {
        this.ctx = ctx;
        ...
        this.globalFilter.connect(destination);
    }
    ...
    public setVolume(val: number) { 
        if (this.masterGain) this.masterGain.gain.value = val * 0.5; 
    }
    ...
    private playBeat(i: number, t: number) {
        ...
        if (i % 4 === 0 && this.masterGain) {
            ...
            this.masterGain.gain.setTargetAtTime(0.35, t + 0.1, 0.1);
        }
